...
Decay_Ad = Decay(name = 'Decay_Ad',
                 particle = P.Ad,
                 partial_widths = {(P.a,P.a):'(AAd**2*CAdaa**2*MAd**6)/(64.*cmath.pi*abs(MAd)**3)'})
...
Decay_H = Decay(name = 'Decay_H',
                particle = P.H,
                partial_widths = {(P.Ad,P.Ad):'(muAd**2*cmath.sqrt(-4*MAd**2*MH**2 + MH**4))/(32.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.Sd,P.Sd):'(muSd**2*cmath.sqrt(MH**4 - 4*MH**2*MSd**2))/(32.*cmath.pi*abs(MH)**3)',
...
Decay_pi0 = Decay(name = 'Decay_pi0',
                  particle = P.pi0,
                  partial_widths = {(P.a,P.a):'(gpiaa**2*Mpi0**6)/(16.*cmath.pi*abs(Mpi0)**3)'})

Decay_Sd = Decay(name = 'Decay_Sd',
                 particle = P.Sd,
                 partial_widths = {(P.a,P.a):'(ASd**2*CSdaa**2*MSd**6)/(64.*cmath.pi*abs(MSd)**3)',
                                   (P.pi0,P.pi0):'(((25*CSd2pi**2*Mpi**4*sh**2)/(9.*vev**2) - (40*CSd2pi**2*Mpi**2*Mpi0**2*sh**2)/(27.*vev**2) + (16*CSd2pi**2*Mpi0**4*sh**2)/(81.*vev**2) + (20*CSd2pi**2*Mpi**2*MSd**2*sh**2)/(27.*vev**2) - (16*CSd2pi**2*Mpi0**2*MSd**2*sh**2)/(81.*vev**2) + (4*CSd2pi**2*MSd**4*sh**2)/(81.*vev**2))*cmath.sqrt(-4*Mpi0**2*MSd**2 + MSd**4))/(32.*cmath.pi*abs(MSd)**3)'})
